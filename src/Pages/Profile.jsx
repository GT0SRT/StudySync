...
function Profile() {
  ...
  return (
    ...
    <div className="flex justify-center items-center  mt-[40%] md:mt-7">
      {userDetails ? (
        <>
          <main class="max-w-xl min-w-[80%] md:min-w-[50%] bg-white rounded-2xl shadow-md overflow-hidden border-2 border-white">
          {/* <!-- Cover image --> */}
          ...
          {/* <!-- Profile & user info --> */}
          <section class="relative px-6 m-7 sm:px-10 -mt-16 flex flex-col items-center text-center">
            ...
            <h1 class="text-2xl sm:text-3xl font-semibold mt-3 tracking-tight text-gray-900">{`${userDetails.firstName} ${userDetails.lastName}`}</h1>
